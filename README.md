...
```javascript
cnegf = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-neg@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-neg@v0.1.1-umd/browser.js"></script>
```
